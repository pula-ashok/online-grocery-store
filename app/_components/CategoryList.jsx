  ...
  return (
    <div className='mt-5'>
        ...
        <div className='grid grid-cols-3 gap-5 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7'>
            ...
            <Link href={`/products-category/${category?.name}`} key={index} className='flex flex-col items-center bg-green-50 gap-2 p-3 mt-2 rounded-lg group cursor-pointer hover:bg-green-200'>
